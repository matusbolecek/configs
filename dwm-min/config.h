...
static const char col_sel[]         = "#ff5555";
static const char col_border[]      = "#4d4d4d";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg, "-nf", col_fg, "-sb", col_sel, "-sf", col_white, NULL };
